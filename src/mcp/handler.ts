...
export const INSTRUCTIONS = [
  ...
  "",
  "Everything on this site is organized by path, exactly like folders. A path is a bundle and holds everything at or under it: the collection /trip/items and the asset /trip/images/coburg.jpg are both in /trip, and /trip/day1/items is in /trip/day1 and in /trip alike. Pages, collections and assets are all just things at paths. Give a new collection or asset a path under the page that uses it and it files itself; list_bundle then returns everything one page is made of.",
  "Matching is on whole path segments, so /bavaria does not hold /bavaria-lessons/lessons. There is no bundle at /: nothing may hold the entire site. The home page lives at /root, which is served at /, and is an ordinary folder like any other.",
  ...
  "delete_page removes one page and leaves the rest of its bundle alone. delete_bundle is the one tool that removes more than one thing: call it without confirm first, read the inventory it returns, and only then confirm.",
  "",
